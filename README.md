...
<a href="https://github.com/m-haziq/highcharts-simplified/">Original project repository. (this project description was copied from there) </a>
...
```
ng new angular8-highcharts
```
You can see that project has been initialized in directory "angular8-highcharts". Now let us run this project:
```
cd angular8-highcharts
ng serve
```
...
using **highcharts** with **angular8**. If you like this effort, please like and share this with others. 
